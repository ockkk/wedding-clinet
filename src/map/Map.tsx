...
export function Map() {
  ...
  return (
    <section>
      ...
      <p>이비스 엠배서더 수원 TEL 031-230-5500</p>
      <p>경기 수원시 팔달구 권광로 132(경기 수원시 팔달구 인계동 1132-12)</p>
      <p>지하철</p>
      <p>분당선 수원시청역 2번 출구 (도보 3분)</p>
      <p>(1호선 수원역에서 분당선으로 환승 - 수원시청역 하차)</p>
      <p>승용차</p>
      <p>
        영동고속도로 이용시(동수원IC 에서 10분 소요)
      </p>
      <p>
        동수원IC -{">"} 광주/수지방면(P턴) -{">"} 300m 직진 후 월드컵경기장 방향 우회전
      </p>
      <p>
        -{">"} 직진 후 고가도록 진입 -{">"} 수원시청역 사거리 지나 200m 후 좌측
      </p>
      <p>경부고롯도록 이용시 (수원IC 에서 20분 소요)</p>
      <p>
        수원IC -{">"} 수원방향 좌회전(42번 국도) -{">"}
      </p>
      <p>
        고가도로 밑 공항버스터미널 앞 좌회전 -{">"} 수원시청역 사거리 지나 200m 후 좌측
      </p>
      <p>전세 버스</p>
